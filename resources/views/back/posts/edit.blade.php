                ...
                <div class="col-md-4">
                    ...
                    @component('back.components.box')
                        ...
                        <div class="form-group {{ $errors->has('tags') ? 'has-error' : '' }}">
                            <input type="text" class="form-control" id="tags" name="tags" value="{{ isset($post) ? implode(',', $post->tags->pluck('tag')->toArray()) : '' }}">
                    ...
                    @component('back.components.box')
                        ...
                        <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug" value="{{ isset($post) ? $post->slug : '' }}">
                    ...
                    @component('back.components.box')
                        ...
                        <div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" rows="3" id="meta_description" name="meta_description">{{isset($post) ? $post->meta_description : ''}}</textarea>
                            {!! $errors->first('meta_description', '<span class="help-block">:message</span>') !!}
                        </div>
                        <div class="form-group {{ $errors->has('meta_keywords') ? 'has-error' : '' }}">
                            <label for="meta_keywords">{{__('META Keywords')}}</label>
                            <textarea class="form-control" rows="3" id="meta_keywords" name="meta_keywords">{{isset($post) ? $post->meta_keywords : ''}}</textarea>
